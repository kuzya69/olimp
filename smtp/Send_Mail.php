...
//		['email'=>'olimpiada24-09@mail.ru', 'uname'=>'olimpiada24-09', 'pass'=>'9ml#o0*pi24'],
	...
	$mail->Host       = "smtp.mail.ru";//"mail.u0689399.cp.regruhosting.ru";//"tls://smtp.scp26.hosting.reg.ru"; // SMTP хост
	$mail->Port       =  465;//587;//465;                    // устанавливаем SMTP порт
	$mail->Username   = $emails[$erand]['uname'];//"u0689399";  //имя пользователя SMTP  
	$mail->Password   = $emails[$erand]['pass'];//"T34K!1d9";  // SMTP пароль
	$mail->SMTPSecure = "ssl";
	$mail->CharSet = "UTF-8";
	$mail->SetFrom($from, 'Olimpiada24');
	$mail->AddReplyTo($from,'Olimpiada24');
